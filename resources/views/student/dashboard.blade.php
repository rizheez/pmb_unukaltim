                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-yellow-700">
                            <p>Saat ini tidak ada periode pendaftaran yang aktif. Silakan tunggu pengumuman lebih lanjut.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="ml-3 flex-1">
                        ...
                        <div class="mt-2 text-sm text-red-700 space-y-2">
                            ...
                            <div class="mt-3 flex items-center gap-3">
                                <a href="{{ route('student.biodata.edit') }}" class="font-medium underline hover:text-red-900">
                                    Perbaiki sekarang →
                                </a>
                            </div>
                        </div>
            ...
            <div class="col-span-1 bg-white shadow rounded-lg p-6 border-t-4 border-teal-600">
                ...
                @else
                    <div class="text-center py-4">
                        ...
                        @else
                            <button disabled class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-gray-400 cursor-not-allowed">
                                Isi Biodata
                            </button>
                        @endif
                    </div>
