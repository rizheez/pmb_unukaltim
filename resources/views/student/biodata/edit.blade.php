...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <form action="{{ route('student.biodata.update') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <div class="mt-2 flex items-center space-x-4">
                        <img src="{{ $biodata->photo_url ?? asset('images/default-avatar.png') }}" 
                             id="photo-preview"
                        ...
                        <label
                            ...
                            <input type="file" name="photo" id="photo" class="hidden" accept="image/*" onchange="previewImage(event, 'photo-preview')">
                        </label>
                    </div>
                ...
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-1">
                            <input type="text" name="name" id="name" value="{{ old('name', $biodata->name ?? auth()->user()->name) }}"
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="date" name="birth_date" id="birth_date" value="{{ old('birth_date', $biodata->birth_date) }}"
                                class="shadow-sm focus:ring-teal-500 focus:border-teal-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="text" name="phone" id="phone" value="{{ old('phone', $biodata->phone ?? auth()->user()->phone) }}"
                                class="shadow-sm focus:ring-teal-500 focus:border-teal-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="text" name="school_origin" id="school_origin" value="{{ old('school_origin', $biodata->school_origin) }}"
                                class="shadow-sm focus:ring-teal-500 focus:border-teal-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <select name="last_education" id="last_education"
                                class="shadow-sm focus:ring-teal-500 focus:border-teal-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                <option value="">Pilih...</option>
                                <option value="SD" {{ old('last_education', $biodata->last_education) == 'SD' ? 'selected' : '' }}>SD</option>
                                <option value="SMP" {{ old('last_education', $biodata->last_education) == 'SMP' ? 'selected' : '' }}>SMP</option>
                                <option value="SMA/SMK Sederajat" {{ old('last_education', $biodata->last_education) == 'SMA/SMK Sederajat' ? 'selected' : '' }}>SMA/SMK Sederajat</option>
                                <option value="D1" {{ old('last_education', $biodata->last_education) == 'D1' ? 'selected' : '' }}>D1</option>
                                <option value="D2" {{ old('last_education', $biodata->last_education) == 'D2' ? 'selected' : '' }}>D2</option>
                                <option value="D3" {{ old('last_education', $biodata->last_education) == 'D3' ? 'selected' : '' }}>D3</option>
                                <option value="D4" {{ old('last_education', $biodata->last_education) == 'D4' ? 'selected' : '' }}>D4</option>
                                <option value="S1" {{ old('last_education', $biodata->last_education) == 'S1' ? 'selected' : '' }}>S1</option>
                                <option value="S2" {{ old('last_education', $biodata->last_education) == 'S2' ? 'selected' : '' }}>S2</option>
                            </select>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="text" name="major" id="major" value="{{ old('major', $biodata->major) }}"
                                class="shadow-sm focus:ring-teal-500 focus:border-teal-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <label class="cursor-pointer bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 block text-center">
                                    ...
                                    <input type="file" name="kk" id="kk" class="hidden" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFilename(event, 'kk-filename')">
                                </label>
                            </div>
                            
                            @if($biodata->kk_url)
                                <div class="mt-2">
                                    <a href="{{ $biodata->kk_url }}" target="_blank" class="text-xs text-teal-600 hover:text-teal-800 inline-flex items-center">
                                        Lihat file saat ini
                                    </a>
                                </div>
                            @endif
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <label class="cursor-pointer bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 block text-center">
                                    ...
                                    <input type="file" name="ktp" id="ktp" class="hidden" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFilename(event, 'ktp-filename')">
                                </label>
                            </div>
                            
                            @if($biodata->ktp_url)
                                <div class="mt-2">
                                    <a href="{{ $biodata->ktp_url }}" target="_blank" class="text-xs text-teal-600 hover:text-teal-800 inline-flex items-center">
                                        Lihat file saat ini
                                    </a>
                                </div>
                            @endif
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <label class="cursor-pointer bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 block text-center">
                                    ...
                                    <input type="file" name="certificate" id="certificate" class="hidden" accept=".pdf,.jpg,.jpeg,.png" onchange="updateFilename(event, 'certificate-filename')">
                                </label>
                            </div>
                            
                            @if($biodata->certificate_url)
                                <div class="mt-2">
                                    <a href="{{ $biodata->certificate_url }}" target="_blank" class="text-xs text-teal-600 hover:text-teal-800 inline-flex items-center">
                                        Lihat file saat ini
                                    </a>
                                </div>
                            @endif
