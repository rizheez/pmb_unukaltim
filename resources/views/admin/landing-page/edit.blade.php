<x-admin-layout>
    ...
    <form action="{{ route('admin.landing-page.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 gap-6">
                <div>
                    ...
                    <input type="text" name="hero_title" 
                           ...
                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500" required>
                    @error('hero_title')
                ...
                <div class="mb-8 last:mb-0 pb-8 last:pb-0 border-b last:border-0">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">See <a href="https://lucide.dev/icons/" target="_blank" class="text-teal-600">lucide.dev</a> for icon names</p>
                        </div>
                    </div>
                </div>
            @endforeach
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="contact_phone" 
                           value="{{ old('contact_phone', $settings['contact']->where('key', 'contact_phone')->first()->value ?? '') }}"
                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500" required>
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">WhatsApp (with country code)</label>
                    <input type="text" name="contact_whatsapp" 
                           value="{{ old('contact_whatsapp', $settings['contact']->where('key', 'contact_whatsapp')->first()->value ?? '') }}"
                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500" 
        ...
        <div class="flex justify-end gap-3">
            ...
            <button type="submit" 
                    class="bg-teal-600 hover:bg-teal-700 text-white px-6 py-3 rounded-md">
                Save Changes
            </button>
        </div>
    </form>
