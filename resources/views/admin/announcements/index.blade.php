<x-admin-layout>
    <div class="mb-6 flex justify-between items-center">
        ...
        <a href="{{ route('admin.announcements.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">Create New</a>
    </div>
                ...
                @foreach ($announcements as $announcement)
                    <tr>
                        <td class="px-6 py-4">
                            ...
                            <div class="text-sm text-gray-500 truncate max-w-xs">{{ Str::limit($announcement->content, 50) }}</div>
                        </td>
