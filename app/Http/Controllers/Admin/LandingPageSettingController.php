...
class LandingPageSettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $request->validate([
            ...
            'hero_background_image_desktop' => 'nullable|image|max:2048',
            'hero_background_image_mobile' => 'nullable|image|max:2048',
        ...
        // Update text fields
        foreach ($request->except(['_token', '_method', 'hero_background_image_desktop', 'hero_background_image_mobile', 'about_image', 'university_logo']) as $key => $value) {
        ...
        // Handle hero background image desktop upload
        if ($request->hasFile('hero_background_image_desktop')) {
            $setting = $allSettings->get('hero_background_image_desktop');
            ...
            $path = $request->file('hero_background_image_desktop')->store('landing-page', 'public');
        ...
        // Handle hero background image mobile upload
        if ($request->hasFile('hero_background_image_mobile')) {
            $setting = $allSettings->get('hero_background_image_mobile');
            ...
            $path = $request->file('hero_background_image_mobile')->store('landing-page', 'public');
